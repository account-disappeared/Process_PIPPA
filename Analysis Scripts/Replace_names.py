...
def process_single_record(record, line_number):
    ...
    bot_definitions = bot_definitions.replace('{{user}}', user_name)
    ...
    bot_description = bot_description.replace('{{user}}', user_name)
...
if __name__ == '__main__':
    ...
    process_jsonl_line_by_line('../Filtered PIPPA/cleaned_filtered_pippa.jsonl',
                               'Other Datasets/names_replaced_pippa.jsonl')